"""
Django settings for admportal project.
...
SECRET_KEY = '3%bx3v*h9!^ih1+06k2q=b3ohr3!j6jx0fj8v_%!bmx-b@^@(='
...
WSGI_APPLICATION = 'admportal.wsgi.application'
